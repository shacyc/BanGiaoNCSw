  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      ...
                                      AND epm.subjectid = 1 AND epm.markgroupid = 1
                                      )
  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      WHERE epm.schoolyearid = 21 
                                      AND epm.schoolclassid = eps.schoolclassid AND   epm.isdeleted = 0
                                      AND epm.subjectid = 1 AND epm.markgroupid = 2)
  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      WHERE epm.schoolyearid = 21 
                                      AND epm.schoolclassid = eps.schoolclassid AND   epm.isdeleted = 0
                                      AND epm.subjectid = 2 AND epm.markgroupid = 1)
  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      WHERE epm.schoolyearid = 21 
                                      AND epm.schoolclassid = eps.schoolclassid AND   epm.isdeleted = 0
                                      AND epm.subjectid = 2 AND epm.markgroupid = 2)
  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      WHERE epm.schoolyearid = 21 
                                      AND epm.schoolclassid = eps.schoolclassid AND   epm.isdeleted = 0
                                      AND epm.subjectid = 3 AND epm.markgroupid = 1
                                      )
  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      WHERE epm.schoolyearid = 21 
                                      AND epm.schoolclassid = eps.schoolclassid AND   epm.isdeleted = 0
                                      AND epm.subjectid = 3 AND epm.markgroupid = 2)
  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      WHERE epm.schoolyearid = 21 
                                      AND epm.schoolclassid = eps.schoolclassid AND   epm.isdeleted = 0
                                      AND epm.subjectid = 4 AND epm.markgroupid = 1)
  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      WHERE epm.schoolyearid = 21 
                                      AND epm.schoolclassid = eps.schoolclassid AND   epm.isdeleted = 0
                                      AND epm.subjectid = 4 AND epm.markgroupid = 2)
