SELECT bang1.organid, bang1.ORGANNAME
      ,bang9.TotalPupil
      ,bang1.totalschool
      ,bang2.totalpino
      ,nvl(bang3.totalgvbm,0) totalgvbm,
       nvl(bang4.totalgvcn,0) totalgvcn,nvl(bang5.totalmarkbook,0) totalmarkbook,
       nvl(bang6.totaldiemdanh,0) totaldiemdanh
        ,nvl(bang7.totaltkb,0)totaltkb
