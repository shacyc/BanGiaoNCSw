  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      ...
                                      AND epm.subjectid = 5 AND epm.markgroupid = 1
                                      )
  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      WHERE epm.schoolyearid = 21 
                                      AND epm.schoolclassid = eps.schoolclassid AND   epm.isdeleted = 0
                                      AND epm.subjectid = 5 AND epm.markgroupid = 2)
  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      WHERE epm.schoolyearid = 21 
                                      AND epm.schoolclassid = eps.schoolclassid AND   epm.isdeleted = 0
                                      AND epm.subjectid = 6 AND epm.markgroupid = 1)
  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      WHERE epm.schoolyearid = 21 
                                      AND epm.schoolclassid = eps.schoolclassid AND   epm.isdeleted = 0
                                      AND epm.subjectid = 6 AND epm.markgroupid = 2)
  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      WHERE epm.schoolyearid = 21 
                                      AND epm.schoolclassid = eps.schoolclassid AND   epm.isdeleted = 0
                                      AND epm.subjectid = 7 AND epm.markgroupid = 1
                                      )
  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      WHERE epm.schoolyearid = 21 
                                      AND epm.schoolclassid = eps.schoolclassid AND   epm.isdeleted = 0
                                      AND epm.subjectid = 7 AND epm.markgroupid = 2)
  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      WHERE epm.schoolyearid = 21 
                                      AND epm.schoolclassid = eps.schoolclassid AND   epm.isdeleted = 0
                                      AND epm.subjectid = 8 AND epm.markgroupid = 1)
  ...
  (
    SELECT SCHOOLID, SCHOOLNAME,EDUCATIONLEVELID, coutHead
        ...
        AND EXISTS(SELECT 1 FROM sams.edu_pupil_markbook  epm  
                                      WHERE epm.schoolyearid = 21 
                                      AND epm.schoolclassid = eps.schoolclassid AND   epm.isdeleted = 0
                                      AND epm.subjectid = 8 AND epm.markgroupid = 2)
