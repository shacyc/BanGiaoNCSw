SELECT /*+MONITOR*/ DISTINCT
    ...
    ,HEADTEACHERNAMEORI
    ,SUPRINCIPALFULLNAME
    ,NVL(EDUCATIONLEVELID,V_EDUCATIONLEVELID) EDUCATIONLEVELID
    ,EDUCATIONLEVEL
    ,SHORTEDUCATIONLEVEL
    ,TITLEBONUS
    ,TEMP.SCHOOLCLASSID
    ...
    (
     SELECT
      DISTINCT
        ...
        CASE WHEN PLACEOFBIRTHCOUNTRYID = T_INTDEFAULTCOUNTRYID
...
--      DECODE(EP.FATHERJOBID,T_JOB_OTHERS,EP.FATHERJOBTITLE,NVL2(MJF.JOBNAME,MJF.JOBNAME,EP.FATHERJOBTITLE)) FATHERJOBNAME,
--      MOTHERFULLNAME,
--      DECODE(EP.MOTHERJOBID,T_JOB_OTHERS,EP.MOTHERJOBTITLE,NVL2(MJM.JOBNAME,MJM.JOBNAME,EP.MOTHERJOBTITLE)) MOTHERJOBNAME,
--      GUARDIANFULLNAME,
--      DECODE(EP.GUARDIANJOBID,T_JOB_OTHERS,EP.GUARDIANJOBTITLE,NVL2(MJW.JOBNAME,MJW.JOBNAME,EP.GUARDIANJOBTITLE)) GUARDIANJOBNAME,
...
--      ,SCHOOLORGANWARD.WARDNAME WARDNAME
      ...
      ,DECODE(EPS.FIRSTTERMSTUDYRANKID,T_EDU_STUDYRANK_LOAIGIOI,'GI?I',T_EDU_STUDYRANK_LOAIKHA,'KHÁ',T_EDU_STUDYRANK_LOAITB,'TRUNG BÌNH',T_EDU_STUDYRANK_LOAIYEU , 'Y?U',T_EDU_STUDYRANK_LOAIKEM,'KÉM','') FIRSTTERMSTUDYRANK
      ,DECODE(EPS.SECONDTERMSTUDYRANKID,T_EDU_STUDYRANK_LOAIGIOI,'GI?I',T_EDU_STUDYRANK_LOAIKHA,'KHÁ',T_EDU_STUDYRANK_LOAITB,'TRUNG BÌNH',T_EDU_STUDYRANK_LOAIYEU , 'Y?U',T_EDU_STUDYRANK_LOAIKEM,'KÉM','') SECONDTERMSTUDYRANK
      ,DECODE(EPS.WHOLEYEARSTUDYRANKID,T_EDU_STUDYRANK_LOAIGIOI,'GI?I',T_EDU_STUDYRANK_LOAIKHA,'KHÁ',T_EDU_STUDYRANK_LOAITB,'TRUNG BÌNH',T_EDU_STUDYRANK_LOAIYEU , 'Y?U',T_EDU_STUDYRANK_LOAIKEM,'KÉM','') WHOLEYEARSTUDYRANK
      ...
      ,TOTALSCHOOLABSENTDAYS
      ,DECODE(EPS.RECHECKSTUDYRANKID,T_EDU_STUDYRANK_LOAIGIOI,'GI?I',T_EDU_STUDYRANK_LOAIKHA,'KHÁ',T_EDU_STUDYRANK_LOAITB,'TRUNG BÌNH',T_EDU_STUDYRANK_LOAIYEU , 'Y?U',T_EDU_STUDYRANK_LOAIKEM,'KÉM','') RECHECKSTUDYRANK
      ...
      ,ep.SUBJECTNAME
        ...
        ,ec.educationlevelid
        ,UPPER(DECODE(NVL(ec.educationlevelid,V_EDUCATIONLEVELID),T_EDUCATIONLEVEL_JUNIORSCHOOL,'TRUNG H?C CO S?',T_EDUCATIONLEVEL_HIGHSCHOOL,'TRUNG H?C PH? THÔNG',T_EDU_EDUCATIONLEVEL_CONT,DECODE(V_EDUCATIONLEVELCONTID,-2,'GDTX C?P TRUNG H?C CO S?',-3, 'GDTX C?P TRUNG H?C PH? THÔNG'))) EDUCATIONLEVEL
        ,NVL2(EDU_STUDYBOOKINFO.REGISTERBOOKNUMBER,(DECODE(NVL(ec.educationlevelid,V_EDUCATIONLEVELID),T_EDUCATIONLEVEL_JUNIORSCHOOL,'S?: ' || TRIM(EDU_STUDYBOOKINFO.REGISTERBOOKNUMBER) || '/THCS',T_EDUCATIONLEVEL_HIGHSCHOOL,'S?: ' || TRIM(EDU_STUDYBOOKINFO.REGISTERBOOKNUMBER) || '/THPT',T_EDU_EDUCATIONLEVEL_CONT,DECODE(V_EDUCATIONLEVELCONTID,-2,'S?: ' || TRIM(EDU_STUDYBOOKINFO.REGISTERBOOKNUMBER) || '/GDTX c?p THCS',-3,'S?: ' || TRIM(EDU_STUDYBOOKINFO.REGISTERBOOKNUMBER) || '/GDTX c?p THPT'))), (DECODE(NVL(ec.educationlevelid,V_EDUCATIONLEVELID),T_EDUCATIONLEVEL_JUNIORSCHOOL,'S?: ............/THCS',T_EDUCATIONLEVEL_HIGHSCHOOL,'S?: ............/THPT',T_EDU_EDUCATIONLEVEL_CONT,DECODE(V_EDUCATIONLEVELCONTID,-2,'S?: ............/GDTX c?p THCS',-3, 'S?: ............/GDTX c?p THPT')))) SHORTEDUCATIONLEVEL
        ,(DECODE(NVL(ec.educationlevelid,V_EDUCATIONLEVELID),T_EDUCATIONLEVEL_JUNIORSCHOOL,'Ðu?c gi?i thu?ng trong các k? thi t? c?p huy?n (qu?n, th? xã) tr? lên:',T_EDUCATIONLEVEL_HIGHSCHOOL,'Ðu?c gi?i thu?ng trong các k? thi t? c?p huy?n tr? lên:','')) TITLEBONUS
        ...
        ,NVL(GETPUPILPOLOBJECTNAMELIST_INFO( EP.PUPILID),'..............................................................................................................') POLICYOBJECTLIST
...
--        ,GETCHANGEMARKBOOKSUBJECTLIST(EP.PUPILID,EPS.SCHOOLYEARID,EPS.SCHOOLCLASSID) TOTALCHANGESUBJECTLIST
        ...
        ,GETTOTALATTENDANCE(EP.PUPILID,2,-1,EPS.SCHOOLYEARID) COUNTATT_PER
        ,GETTOTALATTENDANCE(EP.PUPILID,3,-1,EPS.SCHOOLYEARID) COUNTATT_NOPER
        ,GETTOTALATTENDANCE(EP.PUPILID,2,-1,EPS.SCHOOLYEARID) + GETTOTALATTENDANCE(EP.PUPILID,3,-1,EPS.SCHOOLYEARID) ABSENTCOUNT
        ,EDU_STUDYBOOKINFO.CITIZENEDUCATIONSUBJECTREMARK
        ,EP.SUBJECTID
        ,ep.ORDERINDEX SUBJECTINDEX
        ,DECODE(V_EDUCATIONLEVELCONTID,-1,DECODE(EP.SUBJECTID,8,'                ' || NVL(TEACHER.FULLNAME,TEACHER1.FULLNAME) ||chr(13) || NVL(EDU_STUDYBOOKINFO.citizeneducationsubjectremark,'........................................................................................................................................') ,'                ' || NVL(TEACHER.FULLNAME,TEACHER1.FULLNAME)),NVL2(TEACHER.FULLNAME,'               ' ||TEACHER.FULLNAME,'               ' ||TEACHER1.FULLNAME)) TEACHERFULLNAME
--        ,'                  '||NVL(TEACHER.FULLNAME,TEACHER1.FULLNAME) TEACHERFULLNAME
        ,ep.ORDERINDEX
        ,NVL(EDU_STUDYBOOKINFO.PRIZECONTENT,(DECODE(NVL(ec.educationlevelid,V_EDUCATIONLEVELID),T_EDUCATIONLEVEL_JUNIORSCHOOL,'................................. ...................................................................................................................................................',T_EDUCATIONLEVEL_HIGHSCHOOL,'....................................................... ...................................................................................................................................................','')))PRIZECONTENT
        ,DECODE(V_EDUCATIONLEVELCONTID,-1,NVL(EDU_STUDYBOOKINFO.OTHERREWARD,'................................................................................................... ...................................................................................................................................................'),NVL(EDU_STUDYBOOKINFO.OTHERREWARD,'............................................................................................................. ...................................................................................................................................................')) OTHERREWARD
  ...
  AND SAMS.EDU_PUPIL_RECHECKSUBJECT.SCHOOLCLASSID = EPS.SCHOOLCLASSID
  AND SAMS.EDU_PUPIL_RECHECKSUBJECT.SCHOOLYEARID = EPS.SCHOOLYEARID
  ...
  AND ROWNUM = 1),0) ISRECHECK
       ...
       ,CASE
    WHEN WHOLEYEARSTUDYRANKID = T_EDU_STUDYRANK_LOAIGIOI AND (WHOLEYEARCONDUCTRANKID = T_EDU_CONDUCTRANK_LOAIGIOI OR WHOLEYEARCONDUCTRANKID = T_EDU_CONDUCTRANK_KHONGXL) THEN 'Gi?i' || DECODE(SAMS.EDU_STUDYBOOKINFO.PRIZECONTENT,NULL,'','; ' || TO_CHAR(SAMS.EDU_STUDYBOOKINFO.PRIZECONTENT))
    WHEN WHOLEYEARSTUDYRANKID IN (T_EDU_STUDYRANK_LOAIKHA, T_EDU_STUDYRANK_LOAIGIOI) AND  (WHOLEYEARCONDUCTRANKID IN (T_EDU_CONDUCTRANK_LOAIGIOI, T_EDU_CONDUCTRANK_LOAIKHA ) OR WHOLEYEARCONDUCTRANKID = T_EDU_CONDUCTRANK_KHONGXL) THEN 'Tiên ti?n' || DECODE(SAMS.EDU_STUDYBOOKINFO.PRIZECONTENT,NULL,'','; ' || TO_CHAR(SAMS.EDU_STUDYBOOKINFO.PRIZECONTENT))
    ELSE '..................................................................................................................'
  END AS SIGNIFICATION
        ,T_EDU_STUDYRANK_LOAIGIOI WHOLEYEARSTUDYRANKID
        ,T_EDU_CONDUCTRANK_LOAIGIOI WHOLEYEARCONDUCTRANKID
      ...
      LEFT JOIN SAMS.EDU_CONDUCTRANK EC1 ON EC1.CONDUCTRANKID= EPS.FIRSTTERMCONDUCTRANKID
    ...
    LEFT JOIN sams.EDU_SCHOOLCLASS_NEW ES1 ON ES1.SCHOOLCLASSID=EPS.SCHOOLCLASSID--EPS.SCHOOLCLASSID
          AND ES1.SCHOOLYEARID = EPS.SCHOOLYEARID
          AND ES1.SCHOOLTERMID = EP.SCHOOLTERMID
    LEFT JOIN SAMS.EDU_SUBJECTSECTION
        ON SAMS.EDU_SUBJECTSECTION.SUBJECTSECTIONID = ES1.SUBJECTSECTIONID
     ...
     LEFT JOIN sams.EDU_STUDYBOOKINFO
      ...
      (
        ...
        WHERE EPT.ISDELETED = 0
           AND EPT.SCHOOLYEARID in (2)
          AND EPPT.PUPILID IN ('011593057')
     ...
     LEFT JOIN
      SAMS.EDU_PUPIL_RECHECKSUBJECT
        ...
        SAMS.EDU_PUPIL_RECHECKSUBJECT.PUPILID = TEMP.PUPILID
         AND SAMS.EDU_PUPIL_RECHECKSUBJECT.SCHOOLYEARID in (SELECT * FROM TABLE(SAMS.SPLIT_CLOB(V_SCHOOLYEARIDLIST,',')))
